...
DDPG_RUN_STR3 = '--alg=ddpg --env=wordgame --reward_type=4 --num_timesteps=1e6 --save_path=./models/wordgame_0530 --load_path=./models/wordgame_0530 --assert_file=./assert/collagen.xlsx --play '
