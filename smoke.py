...
NOISE_TYPE_WORD = '--noise_type=adaptive-param_1.0,ou_1.0 --play'

DDPG_RUN_STR = '--alg=ddpg --env=wordgame --num_timesteps=1e6 --save_path=./models/wordgame '
DDPG_RUN_STR2 = '--alg=ddpg --env=Pendulum-v0 --num_timesteps=1e6 --save_path=./models/Pendulum '

def main():
    print('smoke main funtion')
    argstr = DDPG_RUN_STR + NOISE_TYPE_WORD
