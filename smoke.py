...
DDPG_RUN_STR3 = '--alg=ddpg --env=wordgame --num_timesteps=1e6 --save_path=./models/wordgame_0527 --load_path=./models/wordgame_0527 --assert_file=./assert/collagen.xlsx --play '
