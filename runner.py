# -*- coding: utf-8 -*-
"""
Created on Mon May 20 19:23:37 2019
...
class runner_imp(object):
    def __init__(self):
        super(runner_imp,self).__init__()
    
    def train(self,args, extra_args):
    ...
    def get_default_network(self,env_type):
        if env_type in {'atari', 'retro'}:
            return 'cnn'
        else:
            return 'mlp'
    ...
    def get_learn_function(self,alg):
        return self.get_alg_module(alg).learn
    ...
    def parse_cmdline_kwargs(self,args):
        '''
